...
<section class="content">
    <div class="box box-primary">
        <div class="box-header">
            <span class="section"><i class="fa fa-pencil"></i> Registrar Usuario</span>
                    @include('template.includs.headerCreate')
                    {!!Form::open(['route'=>'usuario.store','method'=>'POST', 'class'=>'form-horizontal form-label-left','novalidate','autocomplete'=>'off'])!!}
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="cedula"  class="form-control col-md-7 col-xs-12"  name="cedula"  placeholder="Ingrese el número de cédula o ruc del usuario"required="required" type="cedula_ruc" onkeypress="return Solo_numeros(event)" maxlength="13">
                            </div>
                        </div>
