...
<section class="content">
    <div class="box box-danger">
        <div class="box-header">
            <a href="{!!URL::to('/servicio/create')!!}" class="btn btn-primary"><i class="fa fa fa-pencil"></i> NUEVO</a>
            ...
            @include('template.includs.headerlistar')
             @include('template.servicio.modals.edit')
            ...
            <table class="table table-bordered">
                ...
                <tbody id="lista">
                    ...
                    @stop
                    @section('scripts')
                    {!!Html::script('assets/js/servicio.js')!!}
                    @endsection